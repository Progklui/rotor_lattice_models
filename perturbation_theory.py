...
V_0_range = np.array([1000,2000,10000,20000,100000,200000]) #np.array([0.4,2,4,20,40,100,120]) #np.linspace(0,300,11)
...
params["tx"] = 100
params["ty"] = 100
folder = path+'/results/perturbation_theory/tx_100_ty_100/sp/'
