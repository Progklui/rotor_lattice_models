...
'''
sum_tx_ty = 200
delta_angle = np.array([-0.25,-0.15,-0.05]) #np.array([-0.3,-0.2,-0.1,0.0]) #np.array([0.3,0.2,0.1,0.0]) #np.array([-0.3,-0.2,-0.1,0.0])
diff_tx_ty = np.array([0]) #175, 200 #np.array([0]) # np.array([-200,-175,-150,-125,-100,-75,-50,-25,-1,1,25,50,75,100,125,150,175,200])
V_0_arr = np.arange(150,255,5) #np.arange(120,146,1) #np.arange(150,255,5) #np.arange(70,355,5) #np.array([315,320,325,330,335,340,345,350]) #np.arange(0,355,5)
