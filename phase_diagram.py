...
V_0_arr = np.array([110,115,124,125,127,129]) #np.array([120,121,121.35,121.4,121.6,122,123]) # np.array([163,164,165,166,167,168,169,170,171,172,173]) #  # #np.arange(150,215,5) #np.arange(70,355,5) #np.array([315,320,325,330,335,340,345,350]) #np.arange(0,355,5)
