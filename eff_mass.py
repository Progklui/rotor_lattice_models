...
V_0_arr = np.array([1100,1200]) #np.array([50,100,150,200,250]) #np.array([170]) #np.array([2,4,20,50]) #np.array([100]) #np.array([2,4,20,40,60,80,100]) # np.array([0.02,0.04,4,6,20]) #np.array([0,0.2,0.4,0.6,2,4,6,20,40,60]) # np.arange(0,200,50)
